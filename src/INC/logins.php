...
?>
  <div>
    ...
    <div class="container">
      <div class="loginE">
        <form method="POST" action="/Travelime/login/authenticate">
          <H1>Log In Here</H1>
        ...
        <a href="/Travelime/register" class="row-md-6">Register a new user</a>
        <a href="/Travelime/home" class="row-md-6">Use the website as a guest</a>
      </div>
    </div>
  </div>
<?php
